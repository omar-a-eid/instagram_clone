        ...
        <div>
            ...
            <ul>
                ...
                <li class="flex items-center gap-5"> 
                    <a href="/" class="flex items-center gap-3 text-decoration-none px-4 py-3 rounded-lg transition duration-300 ease-in-out hover:bg-gray-100">
                        <span>
                        ...
                        <h4 class=" text-lg  {{ request()->routeIs('Home') ? 'font-bold' : 'font-medium' }}">Home</h4>
                    </a>
                </li>
                ...
                <!-- Explore -->
                <li>
                    <a href="{{ route('explore') }}" class="flex items-center gap-3 text-decoration-none px-4 py-3 rounded-lg transition duration-300 ease-in-out hover:bg-gray-100">
                        <span>
                        ...
                        <h4 class=" {{ request()->routeIs('explore') ? 'font-bold' : 'font-medium' }} text-lg ">Explore</h4>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" class="flex items-center gap-3 text-decoration-none px-4 py-3 rounded-lg transition duration-300 ease-in-out hover:bg-gray-100">
                        ...
                        @if (request()->routeIs('reels'))
                            ...
                            @else
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" width="24" height="24"
                                    fill="currentColor" id="instagram-reel">
                        ...
                        <h4 class=" text-lg  {{ request()->routeIs('reels') ? 'font-bold' : 'font-medium' }}">Reel</h4>
                    </a>
                </li>
                ...
                <!-- Profile -->
                <li>
                    <a href="{{ route('profile.show', $user->id) }}" class="flex items-center gap-3 text-decoration-none px-4 py-3 rounded-lg transition duration-300 ease-in-out hover:bg-gray-100">
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6">
                            <path d="M12 2c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 2a7 7 0 017 7c0 3.866-3.134 7-7 7s-7-3.134-7-7a7 7 0 017-7zm0 10a2.5 2.5 0 100-5 2.5 2.5 0 000 5z"/>
                        </svg>


                        </span>
                        <h4 class=" text-lg  {{ request()->routeIs('profile.home') ? 'font-bold' : 'font-medium' }} ">Profile</h4>
                    </a>
                </li>
                ...
                <footer class="more-section sticky bottom-0 mt-auto w-full grid px-3 z-50 bg-white">
                    <div class="dropdown dropdown-top">
                        <label for="menu-toggle" tabindex="0" class="cursor-pointer bg-white flex items-center w-full gap-3 m-1">
                            <span>
                                        ...
                                        <form id="updatePhotoForm" action="{{ route('profileEdit.edit', $user->id) }}"
                                            ...
                                            <div class="mb-3">
                                                <label for="profilePhotoInput"
                                                    class="text-primary cursor-pointer">Upload
                                                    Photo</label>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                    ...
                                    <div class="modal-content" style="height: 400px;">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p id="noResultsMessageFollowers" class="text-center"
