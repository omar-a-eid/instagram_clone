    ...
    <div class="container ps-5 mt-5 d-flex justify-content-between">
        ...
        <div class="container">
            <form action="{{route('profileUpdate.update', $user->id )}}" method="POST">
                ...
                <div>
                    <input class="ml-5 mb-3 rounded w-50" type="text" class="form-control" id="genderButton" readonly onclick="showGenderModal()" placeholder="Select Gender" name="gender" value="{{ $user -> gender }}">
                    <p class="ml-4">This won’t be part of your public profile.</p>
                </div>
