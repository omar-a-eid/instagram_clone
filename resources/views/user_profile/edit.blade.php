                    ...
                    <form id="updatePhotoForm" action="{{ route('profileEdit.edit', $user->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input id="profilePhotoInput" name="image" type="file" accept="image/*"
                                style="display: none;" onchange="document.getElementById('updatePhotoForm').submit();">
                        </div>
                    </form>
                    @if ($user->image)
                        <hr class="w-100 mb-3">
            ...
            <div class="flex mb-5 items-center">
                <div class="flex items-center">
                    <div class="w-20 h-20 mr-5">
                        @if ($user->image)
                            <img id="profileImage" width="200px" src="{{ Storage::disk('public')->url($user->image) }}"
                                alt="Profile Photo" class="highlighted-image rounded-full">
                        @else
                            <img id="profileImage" src="{{ asset('assets/images/avatar.jpeg') }}" alt="Profile Photo"
                ...
                <div>
                    ...
                    <label for="profilePhotoInput" class="text-blue-500 cursor-pointer  ml-5">Change Profile
                        Photo</label>
                    <input id="profilePhotoInput" name="image" type="file" accept="image/*" style="display: none;"
