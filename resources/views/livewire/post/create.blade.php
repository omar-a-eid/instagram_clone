<div class="bg-white lg:h-[500px] flex flex-col border gap-y-4 px-5">
    ...
    <main class="grid grid-cols-12 gap-3 h-full overflow-hidden">
        ...
        <aside class="lg:col-span-5 h-full border-l p-3 flex gap-4 flex-col overflow-hidden overflow-y-scroll">
            ...
            <div class=" w-full items-center">
                <input type="text" wire:model="location" placeholder="Add location"
                    ...
                    <li>
                        <div class="flex items-center gap-3 justify-between">
                            ...
                            <label class="relative inline-flex items-center mb-5 cursor-pointer">
                                ...
                                <div
                                    class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 light:peer-focus:ring-blue-800 rounded-full peer light:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                                </div>
                            </label>
                        </div>
                    </li>
