        ...
        <aside class="lg:col-span-4 hidden lg:block p-4">
            ...
            <section class="mt-10">
                ...
                <ol class="flex gap-2 flex-wrap">
                    ...
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">About
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Help
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Press
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">API
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Jobs
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Privacy
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Terms
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Locations
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Language
                            &#x2022;</a></li>
                    <li class="text-xs text-gray-400/90 font-medium"><a href="#" class="hover:underline">Meta
                            Verified</a></li>
